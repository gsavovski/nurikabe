(ns nurikabe.core
  (:gen-class)
  (require [clojure.core.async :as async :refer  [chan >! <! >!! <!! go close! timeout]])
...
; (def b nikoli_10ka) ;ruby 2:08 sec; clojure 9 sec
...
(def numbered-tile-complexity
  {:1 1 :2 4 :3 18 :4 76 :5 315 :6 1296 :7 5320
   :8 21800 :9 89190 :10 364460 :11 1487948 :12 6070332 :37 9999999999999})
